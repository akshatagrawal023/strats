"""
Historical Data Fetcher for Calendar Spread Backtesting
Uses existing historical_data.py infrastructure to fetch data for all shortlisted options
"""
...
class CalendarSpreadDataFetcher:
    def __init__(self, backtest_data_file: str = "nifty50_backtest_data.json"):
        self.backtest_data_file = backtest_data_file
